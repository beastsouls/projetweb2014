...
public class EmployeController extends WebMvcConfigurerAdapter {
	...
	public String submitForm( @Valid @ModelAttribute Employe employe, BindingResult bindingresult) {
	...
	public String listemployes(Model model) {
		...
		model.addAttribute("employes", employeRepository.findAll());return "listEmploye";
	}
